        ...
        >
            ...
            >
                ...
                <div className="w-fit flex flex-col md:items-end items-center md:gap-[3rem] sm:gap-[2rem] gap-[1rem] " >
                    <h2 className="w-full capitalize md:text-end items-center font-bold tracking-[2px] md:text-[84px] sm:text-[64px] text-[38px] " >GBC is here</h2>
